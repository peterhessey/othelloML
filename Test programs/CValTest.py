...
if __name__=='__main__':
    ...
    parser.add_argument('-cD', dest='dark_c_val', type=str, default='r', 
                        help='Type of player to use dark pieces.')
    parser.add_argument('-cW', dest='white_c_val', type=str, default='r', 
                        help='Type of player to use white pieces.')

    args = parser.parse_args()
    NUM_OF_GAMES = int(args.number_of_games[0])
    dark_c_val = int(args.dark_c_val)
    white_c_val = int(args.white_c_val)
